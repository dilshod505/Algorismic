        ...
        >
            <div className={`px-5 md:px-10 lg:px-20 flex items-center justify-between py-7`}>
                ...
                <div className={"hidden sm:flex items-center gap-10"}>
                    ...
                    <a href="/academy-interesded">
                        <h3 className={"hover:text-blue-400 cursor-pointer transition-all duration-300"}>
                            Biz haqimizda
                        </h3>
                    </a>
                    <h3 className={"hover:text-blue-400 cursor-pointer transition-all duration-300"}>
                        <a href="/#trust">Yangiliklar</a>
                    </h3>
                    <a href="/#portfolio">
                        <h3 className={"hover:text-blue-400 cursor-pointer transition-all duration-300"}>
                            Xizmatlar
                    ...
                    <h3 className={"hover:text-blue-400 cursor-pointer transition-all duration-300"}>
                        <a href="/#services">Bog&apos;lanish</a>
                    </h3>
                    <h3 className={"hover:text-blue-400 cursor-pointer transition-all duration-300"}>
                        <a href="/#contacts">Buyurtma berish    </a>
                    </h3>
            ...
            {menuOpen && (
                <div
                    ...
                    <div className="space-y-3">
                        ...
                        <a href="/academy-interesded" onClick={closeMenu}>
                            <h3
                                className={
