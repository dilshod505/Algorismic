            ...
            <div className="px-5 md:px-10 lg:px-20">
                ...
                <Row gutter={[16, 16]} data-aos={'zoom-in'}>
                    <Col xs={24} md={12} lg={6}>
                        <div className="flex items-center justify-center p-5 bg-gray-800 text-white rounded shadow-lg">
                            ...
                            <div className={'cursor-pointer'}>
                                <a href="#" onClick={() => (window.location.href = "tel:+998 97 888 10 27")}>
                                    ...
                                    <p className="text-white">+998 97 888 10 27</p>
                                </a>
                            </div>
                        </div>
                    </Col>
                        ...
                        <div className="flex items-center justify-center p-5 bg-gray-800 text-white rounded shadow-lg">
                            ...
                            <div className={'cursor-pointer'}>
                                <a href="mailto:info@algorismic.uz">
                                    ...
                                    <p className="text-white">info@cloud-solutions.uz</p>
                                </a>
                            </div>
                        </div>
                    </Col>
